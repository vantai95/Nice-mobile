...
export default {
  ...
  // Button
  btnFontFamily: Fonts.primaryRegular,
  ...
  checkboxBgColor: Colors.themeColor,
  checkboxSize: 20,
  ...
  toolbarDefaultBg: Colors.themeColor,
  ...
  topTabBarActiveTextColor: Colors.themeColor,
  topTabBarBorderColor: "#a7a6ab",
  topTabBarActiveBorderColor: Colors.themeColor,
  ...
  // Title
  titleFontfamily: Fonts.primaryBold,
  titleFontSize: 17,
